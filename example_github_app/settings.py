...
if isinstance(GITHUB_SSO_ALLOWABLE_DOMAINS, str):
    GITHUB_SSO_ALLOWABLE_DOMAINS = GITHUB_SSO_ALLOWABLE_DOMAINS.split(",")

GITHUB_SSO_ALLOWABLE_ORGS = env.get_or_default("GITHUB_SSO_ALLOWABLE_ORGS", [])
if isinstance(GITHUB_SSO_ALLOWABLE_ORGS, str):
    GITHUB_SSO_ALLOWABLE_ORGS = GITHUB_SSO_ALLOWABLE_ORGS.split(",")

GITHUB_SSO_NEEDED_REPOS = env.get_or_default("GITHUB_SSO_NEEDED_REPOS", [])
if isinstance(GITHUB_SSO_NEEDED_REPOS, str):
    GITHUB_SSO_NEEDED_REPOS = GITHUB_SSO_NEEDED_REPOS.split(",")
