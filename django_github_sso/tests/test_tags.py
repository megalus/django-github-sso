...
from django_github_sso.templatetags.sso_tags import define_sso_providers
from django_github_sso.utils import adefine_sso_providers
...
def test_tags(client_with_session, settings, callback_request):
    ...
    settings.GITHUB_SSO_PAGES_ENABLED = True
